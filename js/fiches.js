...
window.FICHES = {
  ...
  'fractions_lire': {
    ...
    schema: '<svg viewBox="0 0 220 110" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:220px"><circle cx="60" cy="55" r="45" fill="rgba(168,85,247,0.08)" stroke="#a855f7" stroke-width="1.5"/><path d="M60,55 L60,10 A45,45 0 0,1 99,77.5 Z" fill="rgba(168,85,247,0.45)" stroke="#a855f7" stroke-width="1"/><path d="M60,55 L99,77.5 A45,45 0 0,1 21,77.5 Z" fill="rgba(168,85,247,0.45)" stroke="#a855f7" stroke-width="1"/><path d="M60,55 L21,77.5 A45,45 0 0,1 60,10 Z" fill="rgba(168,85,247,0.08)" stroke="#a855f7" stroke-width="1"/><text x="60" y="105" text-anchor="middle" fill="#a855f7" font-size="12" font-family="sans-serif">3 parts prises sur 4 → 3/4</text><text x="155" y="30" fill="rgba(255,255,255,0.8)" font-size="13" font-family="sans-serif" font-weight="bold">3</text><line x1="148" y1="35" x2="175" y2="35" stroke="rgba(255,255,255,0.5)" stroke-width="1.5"/><text x="155" y="50" fill="rgba(255,255,255,0.6)" font-size="13" font-family="sans-serif">4</text><text x="148" y="20" fill="rgba(255,255,255,0.4)" font-size="10" font-family="sans-serif">numérateur</text><text x="148" y="62" fill="rgba(255,255,255,0.4)" font-size="10" font-family="sans-serif">dénominateur</text></svg>',
  ...
  'fractions_comparer': {
    ...
    schema: '<svg viewBox="0 0 220 120" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:220px"><circle cx="55" cy="55" r="42" fill="rgba(168,85,247,0.08)" stroke="#a855f7" stroke-width="1.5"/><path d="M55,55 L55,13 A42,42 0 0,1 91.4,76 Z" fill="rgba(168,85,247,0.5)" stroke="#a855f7" stroke-width="1"/><path d="M55,55 L91.4,76 A42,42 0 0,1 18.6,76 Z" fill="rgba(168,85,247,0.08)" stroke="#a855f7" stroke-width="1"/><path d="M55,55 L18.6,76 A42,42 0 0,1 55,13 Z" fill="rgba(168,85,247,0.08)" stroke="#a855f7" stroke-width="1"/><text x="55" y="110" text-anchor="middle" fill="#a855f7" font-size="13" font-family="sans-serif" font-weight="bold">1/3</text><circle cx="165" cy="55" r="42" fill="rgba(78,205,196,0.08)" stroke="#4ecdc4" stroke-width="1.5"/><path d="M165,55 L165,13 A42,42 0 0,1 204.9,68.2 Z" fill="rgba(78,205,196,0.5)" stroke="#4ecdc4" stroke-width="1"/><path d="M165,55 L204.9,68.2 A42,42 0 0,1 183.9,95.3 Z" fill="rgba(78,205,196,0.08)" stroke="#4ecdc4" stroke-width="1"/><path d="M165,55 L183.9,95.3 A42,42 0 0,1 146.1,95.3 Z" fill="rgba(78,205,196,0.08)" stroke="#4ecdc4" stroke-width="1"/><path d="M165,55 L146.1,95.3 A42,42 0 0,1 125.1,68.2 Z" fill="rgba(78,205,196,0.08)" stroke="#4ecdc4" stroke-width="1"/><path d="M165,55 L125.1,68.2 A42,42 0 0,1 165,13 Z" fill="rgba(78,205,196,0.08)" stroke="#4ecdc4" stroke-width="1"/><text x="165" y="110" text-anchor="middle" fill="#4ecdc4" font-size="13" font-family="sans-serif" font-weight="bold">1/5</text><text x="110" y="58" text-anchor="middle" fill="rgba(255,255,255,0.7)" font-size="16" font-family="sans-serif">&gt;</text></svg>',
  ...
  'perimetre': {
    titre: 'Le Périmètre',
    schema: '<svg viewBox="0 0 220 130" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:220px"><rect x="25" y="30" width="150" height="70" fill="rgba(74,158,255,0.08)" stroke="#4a9eff" stroke-width="2" rx="2"/><line x1="25" y1="16" x2="175" y2="16" stroke="#4ecdc4" stroke-width="1.5"/><line x1="25" y1="11" x2="25" y2="21" stroke="#4ecdc4" stroke-width="1.5"/><line x1="175" y1="11" x2="175" y2="21" stroke="#4ecdc4" stroke-width="1.5"/><text x="100" y="12" text-anchor="middle" fill="#4ecdc4" font-size="11" font-family="sans-serif">L (longueur)</text><line x1="192" y1="30" x2="192" y2="100" stroke="#ff8c42" stroke-width="1.5"/><line x1="187" y1="30" x2="197" y2="30" stroke="#ff8c42" stroke-width="1.5"/><line x1="187" y1="100" x2="197" y2="100" stroke="#ff8c42" stroke-width="1.5"/><text x="209" y="69" text-anchor="middle" fill="#ff8c42" font-size="11" font-family="sans-serif" transform="rotate(90 209 69)">l (largeur)</text><text x="100" y="70" text-anchor="middle" fill="rgba(255,255,255,0.4)" font-size="11" font-family="sans-serif">P = 2 × (L + l)</text><text x="100" y="120" text-anchor="middle" fill="rgba(255,255,255,0.35)" font-size="10" font-family="sans-serif">↑ tour complet = périmètre</text></svg>',
  ...
  'aire': {
    titre: 'L\'Aire',
    schema: '<svg viewBox="0 0 220 145" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:220px"><rect x="25" y="25" width="150" height="80" fill="rgba(74,158,255,0.25)" stroke="#4a9eff" stroke-width="2" rx="2"/><line x1="25" y1="14" x2="175" y2="14" stroke="#4ecdc4" stroke-width="1.5"/><line x1="25" y1="9" x2="25" y2="19" stroke="#4ecdc4" stroke-width="1.5"/><line x1="175" y1="9" x2="175" y2="19" stroke="#4ecdc4" stroke-width="1.5"/><text x="100" y="10" text-anchor="middle" fill="#4ecdc4" font-size="11" font-family="sans-serif">L (longueur)</text><line x1="13" y1="25" x2="13" y2="105" stroke="#ff8c42" stroke-width="1.5"/><line x1="8" y1="25" x2="18" y2="25" stroke="#ff8c42" stroke-width="1.5"/><line x1="8" y1="105" x2="18" y2="105" stroke="#ff8c42" stroke-width="1.5"/><text x="6" y="69" text-anchor="middle" fill="#ff8c42" font-size="11" font-family="sans-serif" transform="rotate(-90 6 69)">l (largeur)</text><text x="100" y="68" text-anchor="middle" fill="rgba(255,255,255,0.8)" font-size="14" font-family="sans-serif" font-weight="bold">A = L × l</text><text x="100" y="130" text-anchor="middle" fill="rgba(255,255,255,0.35)" font-size="10" font-family="sans-serif">↑ surface colorée = aire (en cm²)</text><rect x="25" y="112" width="12" height="12" fill="rgba(74,158,255,0.25)" stroke="#4a9eff" stroke-width="1"/><text x="42" y="122" fill="rgba(255,255,255,0.4)" font-size="10" font-family="sans-serif">= 1 cm²</text></svg>',
  ...
  'angles': {
    ...
    schema: '<svg viewBox="0 0 220 155" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:220px"><line x1="45" y1="58" x2="85" y2="58" stroke="#a855f7" stroke-width="2"/><line x1="45" y1="58" x2="73" y2="30" stroke="#a855f7" stroke-width="2"/><path d="M65,58 A20,20 0 0,0 59,44" fill="none" stroke="#a855f7" stroke-width="1.2" opacity="0.7"/><text x="45" y="74" fill="rgba(255,255,255,0.75)" font-size="9.5" font-family="sans-serif">aigu &lt; 90°</text><line x1="155" y1="58" x2="195" y2="58" stroke="#4ecdc4" stroke-width="2"/><line x1="155" y1="58" x2="155" y2="20" stroke="#4ecdc4" stroke-width="2"/><rect x="155" y="49" width="9" height="9" fill="none" stroke="#4ecdc4" stroke-width="1.5"/><text x="148" y="74" fill="rgba(255,255,255,0.75)" font-size="9.5" font-family="sans-serif">droit 90°</text><line x1="45" y1="118" x2="85" y2="118" stroke="#f59e0b" stroke-width="2"/><line x1="45" y1="118" x2="25" y2="83" stroke="#f59e0b" stroke-width="2"/><path d="M65,118 A20,20 0 0,0 35,101" fill="none" stroke="#f59e0b" stroke-width="1.2" opacity="0.7"/><text x="31" y="135" fill="rgba(255,255,255,0.75)" font-size="9.5" font-family="sans-serif">obtus &gt; 90°</text><line x1="118" y1="118" x2="202" y2="118" stroke="rgba(255,255,255,0.6)" stroke-width="2"/><circle cx="160" cy="118" r="2.5" fill="rgba(255,255,255,0.5)"/><path d="M180,118 A20,20 0 1,0 140,118" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.5)" stroke-width="1.2"/><text x="136" y="145" fill="rgba(255,255,255,0.75)" font-size="9.5" font-family="sans-serif">plat = 180°</text></svg>',
